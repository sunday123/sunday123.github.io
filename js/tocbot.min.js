    ...
    var e = {
        163: e => {
            e.exports = function (e) {
                ...
                function s(t, l) {
                    var o, r, c,
                        d = l.appendChild((o = t, r = document.createElement("li"), c = document.createElement("a"), e.listItemClass && r.setAttribute("class", e.listItemClass), e.onClick && (c.onclick = e.onClick), e.includeTitleTags && c.setAttribute("title", o.textContent), e.includeHtml && o.childNodes.length ? n.call(o.childNodes, (function (e) {
                            c.appendChild(e.cloneNode(!0))
                        })) : c.textContent = o.textContent, c.setAttribute("href", e.basePath + "#" + o.id), c.setAttribute("class", e.linkClass + i + "node-name--" + o.nodeName + i + e.extraLinkClasses), r.appendChild(c), r));
                ...
                return {
                    enableTocAnimation: function () {
                        ...
                        if (r && null !== t && f.length > 0) {
                            ...
                            C && -1 === C.className.indexOf(e.activeListItemClass) && (C.className += i + e.activeListItemClass);
                            ...
                            })), p && p.nextSibling && -1 !== p.nextSibling.className.indexOf(e.isCollapsedClass) && (p.nextSibling.className = p.nextSibling.className.split(i + e.isCollapsedClass).join("")), d(p && p.parentNode.parentNode)
                        }
                    }
                }
            }
            ...
            var l, o, r;
            o = [], void 0 === (r = "function" == typeof (l = function (e) {
                "use strict";
                var t, l, o, r = n(547), i = {}, s = {}, a = n(163), c = n(279), d = n(938),
                    ...
                    return s.destroy = function () {
                        ...
                        if (u) {
                            i = function () {
                                ...
                                return e
                            }(r, e || {}), this.options = i, this.state = {}, i.scrollSmooth && (i.duration = i.scrollSmoothDuration, i.offset = i.scrollSmoothOffset, s.scrollSmooth = n(374).initSmoothScrolling(i)), t = a(i), l = c(i), this._buildHtml = t, this._parseContent = l, this._headingsArray = o, s.destroy();
                            var p = function (e) {
                                try {
                            ...
                            if (null !== p) {
                                ...
                                if (null !== C && null !== (o = l.selectHeadings(p, i.headingSelector))) {
                                    ...
                                    i.skipRendering || t.render(C, g), this._scrollListener = m((function (e) {
                                    ...
                                    return this._clickListener = m((function (e) {
                                        i.scrollSmooth && t.disableTocAnimation(e), t.updateToc(o), v && clearTimeout(v), v = setTimeout((function () {
                    ...
                    nestHeadingsArray: function (l) {
                        return t.call(l, (function (t, l) {
                            ...
                            return r && function (t, l) {
                                for (var r = o(t), i = r.headingLevel, s = l, a = n(s), c = i - (a ? a.headingLevel : 0); c > 0 && (!(a = n(s)) || i !== a.headingLevel);) a && void 0 !== a.children && (s = a.children), c--;
            ...
            t.initSmoothScrolling = function (e) {
                var t = e.duration, n = e.offset, l = location.hash ? o(location.href) : location.href;
                ...
                document.body.addEventListener("click", (function (r) {
                    ...
                    "a" !== (i = r.target).tagName.toLowerCase() || !(i.hash.length > 0 || "#" === i.href.charAt(i.href.length - 1)) || o(i.href) !== l && o(i.href) + "#" !== l || r.target.className.indexOf("no-smooth-scroll") > -1 || "#" === r.target.href.charAt(r.target.href.length - 2) && "!" === r.target.href.charAt(r.target.href.length - 1) || -1 === r.target.className.indexOf(e.linkClass) || function (e, t) {
                        var n, l, o = window.pageYOffset, r = {
                            ...
                            a = "function" == typeof r.duration ? r.duration(s) : r.duration;

                        function c(e) {
                            l = e - n, window.scrollTo(0, r.easing(l, o, s, a)), l < a ? requestAnimationFrame(c) : (window.scrollTo(0, o + s), "function" == typeof r.callback && r.callback())
                        }
